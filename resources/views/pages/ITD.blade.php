...
<section class="hero-about">
    ...
    <img src="{{ asset('assets/images/pexels-pixabay-164527.jpg') }}" alt="About Us" class="hero-img">
        <div class="hero-content container">
                <h1 class="display-4 fw-bold mb-4">Income Tax Department Services</h1>
                <p class="lead mb-4">
                    We offer complete income tax services to make sure everything is accurate, legal, and stress-free. 
                    With years of experience and a deep understanding of tax laws, we make the process simple and easy for you.
                </p>
        </div>
    </div>
</section>
...
<div class="py-5">
    <div class="container">
        ...
        <div class="row">
            <div class="col-12">
                <h2 class="fw-bold custom-heading custom-line mb-4">Tax Slabs for FY 2024-25 (Old Regime)</h2>
                <div class="table-responsive">
                    <table class="table table-bordered tax-table">
                        ...
                        <tbody>
                            <tr><td>Up to Rs. 2.5 lakh</td><td>Nil</td></tr>
                            <tr><td>Rs. 2.5 lakh - Rs. 5 lakh</td><td>5%</td></tr>
                            <tr><td>Rs. 5 lakh - Rs. 10 lakh</td><td>20%</td></tr>
                            <tr><td>Rs. 10 lakh - Rs. 12 lakh</td><td>30%</td></tr>
                        </tbody>
                    </table>
                </div>
            </div>
            ...
            <div class="col-12 mt-5">
                <h2 class="fw-bold custom-heading custom-line mb-4">Tax Slabs for FY 2024-25 (New Regime)</h2>
                <div class="table-responsive">
                    <table class="table table-bordered tax-table">
                        <thead>
                            <tr>
                        ...
                        <tbody>
                            <tr><td>Up to Rs. 3 lakh</td><td>Nil</td></tr>
                            <tr><td>Rs. 3 lakh - Rs. 7 lakh</td><td>5%</td></tr>
                            <tr><td>Rs. 7 lakh - Rs. 10 lakh</td><td>10%</td></tr>
                            <tr><td>Rs. 10 lakh - Rs. 12 lakh</td><td>15%</td></tr>
                            <tr><td>Rs. 12 lakh - Rs. 15 lakh</td><td>20%</td></tr>
                            <tr><td>Above Rs. 15 lakh</td><td>30%</td></tr>
                        </tbody>
                    </table>
                </div>
            </div>
