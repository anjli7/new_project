...
<section class="hero-about">
    <div class="hero-overlay">
        <img src="{{ asset('assets/images/about-us.jpg') }}" alt="About Us" class="hero-img">
        <div class="hero-content container">
            <h1>Expert Financial Solutions</h1>
            <p>
                With over 15 years of experience in financial management and accounting,
                we provide expert solutions tailored to your specific needs.
            </p>
        </div>
    </div>
</section>
    ...
    <div class="container">
      ...
      <div class="about-content">
        <div class="about-image">
          <img src="{{asset('assets/images/about-us.jpg')}}" alt="Chartered Accountants Team" />
        </div>
      ...
      <div class="team-grid">
        <div class="team-member">
          <div class="team-photo">
            <img src="{{asset('assets/images/blank.jpg')}}" alt="Team Member" />
          </div>
          <div class="team-info">
            <h3>Rajesh Kumar</h3>
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-12 col-lg-6 mb-4 mb-lg-0">
          <form class="common-contact-form" id="common-form1" action="{{ route('about.InsertAbout') }}" method="POST">
            @csrf
            <div class="row g-3">
              <div class="col-md-6">
